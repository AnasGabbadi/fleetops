...
class VehicleWithoutDriver extends FleetbaseResource
{
    ...
    public function toArray($request)
    {
        return $this->withCustomFields([
            ...
            'loan_provider'          => $this->loan_provider,
            'loan_last_payment'      => $this->loan_last_payment,
            // Dates
            'purchased_at'           => $this->purchased_at,
            'lease_expires_at'       => $this->lease_expires_at,
            'assurance_date'         => $this->assurance_date,
            'assurance_expiry'       => $this->assurance_expiry,
            'vignette_date'          => $this->vignette_date,
            'vignette_expiry'        => $this->vignette_expiry,
            'visite_technique_date'  => $this->visite_technique_date,
            'visite_technique_expiry'=> $this->visite_technique_expiry,
            'carte_grise_date'       => $this->carte_grise_date,
            'carte_grise_expiry'     => $this->carte_grise_expiry,
